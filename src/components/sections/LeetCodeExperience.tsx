...
export default function LeetCodeExperience() {
  ...
  return (
    <section className="w-full bg-[#050505] text-foreground py-32 md:py-48 relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10" ref={ref}>
        ...
        <div className="text-center mb-24">
          ...
          <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-white mb-6">The Algorithm<br />Journey.</h2>
